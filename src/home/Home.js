...
import { SafeAreaView, useColorScheme, StyleSheet, Text, View, Appearance, ScrollView, Image, FlatList, Button, Pressable } from 'react-native';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{paddingBlock:20}}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View>
              ...
              <View style={styles.post}>
                <Text style={{ color: "white", textAlign: "center", width: "100%" }}>{item.post_description}</Text>
              </View>
              {/* like ,comment area */}
          ...
          ItemSeparatorComponent={<View style={{ height: 2, width: "100%", margin: 'auto', backgroundColor: "#909090", marginBlock: 10, marginBottom: 20 }}></View>}
        />
